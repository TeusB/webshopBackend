            ...
            <tbody id="products">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="bekijk">bekijk / wijzig</button><button type="button" class="delete">verwijder</button>
                            </td>
                        </tr>
                <?php
                    }
